...
<div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
    <div class="mdk-drawer-layout__content page-content">
        ...
        <div class="navbar navbar-expand navbar-light border-bottom-2" id="default-navbar" data-primary>
            ...
            <!-- Navbar Brand -->
            <a href="compact-index.html" class="navbar-brand mr-16pt d-lg-none">
            ...
            <ul class="nav navbar-nav d-none d-sm-flex flex justify-content-start ml-8pt">
                <li class="nav-item">
                    <a href="compact-index.html" class="nav-link">Home</a>
                </li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">Courses</a>
                    <div class="dropdown-menu">
                        <a href="compact-courses.html" class="dropdown-item">Browse Courses</a>
                        <a href="compact-student-course.html" class="dropdown-item">Preview Course</a>
                        <a href="compact-student-lesson.html" class="dropdown-item">Preview Lesson</a>
                        <a href="compact-student-take-course.html" class="dropdown-item"><span class="mr-16pt">Take Course</span> <span class="badge badge-notifications badge-accent text-uppercase ml-auto">Pro</span></a>
                        <a href="compact-student-take-lesson.html" class="dropdown-item">Take Lesson</a>
                        <a href="compact-student-take-quiz.html" class="dropdown-item">Take Quiz</a>
                        <a href="compact-student-quiz-result-details.html" class="dropdown-item">Quiz Result</a>
                        <a href="compact-student-dashboard.html" class="dropdown-item">Student Dashboard</a>
                        <a href="compact-student-my-courses.html" class="dropdown-item">My Courses</a>
                        <a href="compact-student-quiz-results.html" class="dropdown-item">My Quizzes</a>
                        <a href="compact-help-center.html" class="dropdown-item">Help Center</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">Paths</a>
                    <div class="dropdown-menu">
                        <a href="compact-paths.html" class="dropdown-item">Browse Paths</a>
                        <a href="compact-student-path.html" class="dropdown-item">Path Details</a>
                        <a href="compact-student-path-assessment.html" class="dropdown-item">Skill Assessment</a>
                        <a href="compact-student-path-assessment-result.html" class="dropdown-item">Skill Result</a>
                        <a href="compact-student-paths.html" class="dropdown-item">My Paths</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a href="compact-pricing.html" class="nav-link">Pricing</a>
                </li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">Teachers</a>
                    <div class="dropdown-menu">
                        <a href="compact-instructor-dashboard.html" class="dropdown-item">Instructor Dashboard</a>
                        <a href="compact-instructor-courses.html" class="dropdown-item">Manage Courses</a>
                        <a href="compact-instructor-quizzes.html" class="dropdown-item">Manage Quizzes</a>
                        <a href="compact-instructor-earnings.html" class="dropdown-item">Earnings</a>
                        <a href="compact-instructor-statement.html" class="dropdown-item">Statement</a>
                        <a href="compact-instructor-edit-course.html" class="dropdown-item">Edit Course</a>
                        <a href="compact-instructor-edit-quiz.html" class="dropdown-item">Edit Quiz</a>
                    </div>
                </li>
                <li class="nav-item dropdown active" data-toggle="tooltip" data-title="Community" data-placement="bottom" data-boundary="window">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
                        <i class="material-icons">people_outline</i>
                    </a>
                    <div class="dropdown-menu">
                        <a href="compact-teachers.html" class="dropdown-item">Browse Teachers</a>
                        <a href="compact-student-profile.html" class="dropdown-item">Student Profile</a>
                        <a href="compact-teacher-profile.html" class="dropdown-item">Instructor Profile</a>
                        <a href="compact-blog.html" class="dropdown-item active">Blog</a>
                        <a href="compact-blog-post.html" class="dropdown-item">Blog Post</a>
                        <a href="compact-faq.html" class="dropdown-item">FAQ</a>
                        <a href="compact-help-center.html" class="dropdown-item">Help Center</a>
                        <a href="compact-discussions.html" class="dropdown-item">Discussions</a>
                        <a href="compact-discussion.html" class="dropdown-item">Discussion Details</a>
                        <a href="compact-discussions-ask.html" class="dropdown-item">Ask Question</a>
                    </div>
                </li>
            </ul>


            <form class="search-form navbar-search d-none d-lg-flex mr-16pt" action="compact-index.html" style="max-width: 230px">
            ...
            <ul class="nav navbar-nav ml-auto mr-0">
                <li class="nav-item">
                    <a href="compact-login.html" class="nav-link" data-toggle="tooltip" data-title="Login" data-placement="bottom" data-boundary="window"><i class="material-icons">lock_open</i></a>
                </li>
                <li class="nav-item">
                    <a href="compact-signup.html" class="btn btn-outline-dark">Get Started</a>
                </li>
            </ul>
        </div>
        ...
        <div class="mdk-drawer__content js-sidebar-mini" data-responsive-width="992px" data-layout="compact">
            ...
            <div class="sidebar sidebar-mini sidebar-dark-dodger-blue sidebar-left d-flex flex-column">
                ...
                <div class="flex d-flex flex-column justify-content-start" data-perfect-scrollbar>
                    <ul class="nav flex-shrink-0 flex-nowrap flex-column sidebar-menu mb-0 sm-item-bordered js-sidebar-mini-tabs" role="tablist">
                        <li class="sidebar-menu-item" data-title="Student" data-placement="right" data-boundary="window">
                            <a class="sidebar-menu-button" href="#sm_student" data-toggle="tab" role="tab" aria-controls="sm_student" aria-selected="true">
                                <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">school</i>
                                <span class="sidebar-menu-text">Student</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item" data-title="Instructor" data-placement="right" data-container="body" data-boundary="window">
                            <a class="sidebar-menu-button" href="#sm_instructor" data-toggle="tab" role="tab" aria-controls="sm_instructor" aria-selected="false">
                        ...
                        <li class="sidebar-menu-item  active " data-title="Apps" data-placement="right" data-container="body" data-boundary="window">
                            <a class="sidebar-menu-button" href="#sm_apps" data-toggle="tab" role="tab" aria-controls="sm_apps">
            ...
            <div class="sidebar sidebar-light sidebar-left flex sidebar-secondary pt-16pt" data-perfect-scrollbar>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane  fade active show " id="sm_apps">
...
<span class="sidebar-menu-text">Inventory</span>
                            ...
                            <li class="sidebar-menu-item active open">
                                ...
                                <ul class="sidebar-submenu collapse show sm-indent" id="community_menu">
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="compact-teachers.html">

                                            <span class="sidebar-menu-text">Browse Teachers</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="compact-student-profile.html">

                                            <span class="sidebar-menu-text">Student Profile</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="compact-teacher-profile.html">

                                            <span class="sidebar-menu-text">Teacher Profile</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item active">
                                        <a class="sidebar-menu-button" href="compact-blog.html">

                                            <span class="sidebar-menu-text">Blog</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="compact-blog-post.html">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="compact-help-center.html">
                                            <!--  -->
...
<span class="sidebar-menu-text">Team Members</span>
                    ...
                    <div class="tab-pane " id="sm_student">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-courses.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">local_library</span>
                                    <span class="sidebar-menu-text">Browse Courses</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-paths.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">style</span>
                                    <span class="sidebar-menu-text">Browse Paths</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-dashboard.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">account_box</span>
                                    <span class="sidebar-menu-text">Student Dashboard</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-my-courses.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">search</span>
                                    <span class="sidebar-menu-text">My Courses</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-paths.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">timeline</span>
                                    <span class="sidebar-menu-text">My Paths</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-path.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">change_history</span>
                                    <span class="sidebar-menu-text">Path Details</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-course.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">face</span>
                                    <span class="sidebar-menu-text">Course Preview</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-lesson.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">panorama_fish_eye</span>
                                    <span class="sidebar-menu-text">Lesson Preview</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-take-course.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-take-lesson.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">import_contacts</span>
                                    <span class="sidebar-menu-text">Take Lesson</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-take-quiz.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">dvr</span>
                                    <span class="sidebar-menu-text">Take Quiz</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-quiz-results.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">poll</span>
                                    <span class="sidebar-menu-text">My Quizzes</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-quiz-result-details.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">live_help</span>
                                    <span class="sidebar-menu-text">Quiz Result</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-path-assessment.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">layers</span>
                                    <span class="sidebar-menu-text">Skill Assessment</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-student-path-assessment-result.html">
                    ...
                    <div class="tab-pane " id="sm_instructor">
                        <div class="sidebar-heading">Instructor</div>
                        <ul class="sidebar-menu">


                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-instructor-dashboard.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-instructor-quizzes.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">help</span>
                                    <span class="sidebar-menu-text">Manage Quizzes</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-instructor-earnings.html">
                                    <span class="material-icons sidebar-menu-icon sidebar-menu-icon--left">trending_up</span>
                                    <span class="sidebar-menu-text">Earnings</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-instructor-statement.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="compact-instructor-edit-quiz.html">
...
<span class="sidebar-menu-text">Chips</span>
                    ...
                    <div class="tab-pane" id="sm_layouts">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-blog.html">
                                    <span class="sidebar-menu-text">Mini</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="mini-secondary-blog.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="boxed-blog.html">
                                    <span class="sidebar-menu-text">Boxed</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="sticky-blog.html">
